...
name_of_extraction = 'global_req_tsinp'
variables = ['temperature','salinity','phosphate','nitrate','silicate']
#variables = ['nitrate','silicate']
max_depth = 2000.

files = [os.path.join(scratch,'wod2013','wod_'+name_of_extraction,f)
         for f in ['ocldb1502816882.5140.OSD']]
...
if split_phase and tm.total_elapsed_time() > 1:
    ...
    call('bsub < run_global_req_temp_salt_po4_no3_si.py',shell=True)
    sys.exit(0)
