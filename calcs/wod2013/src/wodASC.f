...
c*****************************************************************
      ...
      character*512 filename,fileout
...
c*******************************************************************
     ...
     *     6500., 7000., 7500., 8000., 8500., 9000./
      ...
      namelist /input/ filename,ifld,fileout
      idepthset=0
...
c      write(6,*)' '
c      write(6,*)'Input File Name (no quotes):'
c      read(5,'(a80)') filename

c      write(6,*) 'Which input field would you like to write?'
c      write(6,*) '1-Temperature 2-Salinity 3-Oxygen 4-Phosphate'
c      write(6,*) '5-Total Phosphorus 6-Silicate 7-Nitrite '
c      write(6,*) '8-Nitrate 9-pH 10-Ammonia 11-Chlorophyll'
c      write(6,*) '12-Phaeophytin 13-Primary Prod 14-Biochem'
c      write(6,*) '15-LightC14 16-DarkC14 17-Alkalinity '
c      write(6,*) '18-POC 19-DOC 20-pCO2 21-TCO2 22-XCO2sea' 
c      write(6,*) '23-NO2NO3 24-Transmissivity 25-Pressure'
c      write(6,*) '26-Conductivity 33-Tritium 34-Helium'
c      write(6,*) '35-DeltaHe 36-DeltaC14 37-DeltaC13'
c      write(6,*) '38-Argon 39-Neon 40-CFC11'
c      write(6,*) '41-CFC12 42-CFC113 43-O18'

c      read(5,*) ifld

c      write(6,*) ' Write output file name (no quotes):'
C      read(5,'(a80)') fileout


c      open(10,file='input.nml')
      read(5,nml=input)
      write(*,nml=input)
      close(10)
...
c      write(6,*)' Enter how many casts to display'
c      write(6,*)' For all casts in file, enter 0 (zero)'
c      read(5,*) iendcast
      iendcast = 0
...
c       write(6,*)'writing to file --> ',
c     *   rlon, rlat, iyear, month, iday

       write(22,*) '% ', jj, rlon, rlat, iyear, month, iday
